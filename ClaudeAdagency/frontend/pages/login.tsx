...
/* CS Logo (image) */
const CSLogo = ({ size = 100 }: { size?: number }) => (
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center nebula-bg" style={{ background: '#050B18' }}>
      <div className="w-full max-w-md px-4 relative z-10">

        {/* Logo */}
        <div className="text-center mb-8">
          <Link href="/" className="inline-block logo-glow">
            <CSLogo size={100} />
          </Link>
          <h1 className="text-3xl font-bold text-white mt-4 tracking-tight">The Craft Studio</h1>
          <p className="text-[#94A3B8] mt-2 text-sm">AI-Powered Instagram Reels</p>
        </div>

        {/* Card */}
        <div className="glass rounded-2xl p-8 border border-[rgba(123,46,255,0.2)]">
          <h2 className="text-xl font-bold text-white text-center mb-2">Sign in to Studio</h2>
          ...
          {/* Google Sign In — neon style */}
          <button
            onClick={handleGoogleLogin}
            className="neon-btn w-full gap-3"
          ...
          <div className="mt-6 text-center">
            <p className="text-[#94A3B8] text-xs">
              ...
              <br />New users get <span className="text-[#E040FB] font-semibold">30 free credits</span> to start.
            </p>
          </div>
        </div>
