      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden space-bg circuit-bg">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h1 className="font-display text-6xl md:text-7xl lg:text-8xl text-white mb-6 uppercase leading-none">
            Reels That<br />
            <span className="gradient-text">Actually Go Viral</span>
          </h1>
          <p className="text-[#94A3B8] text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
            Professional Instagram reels from concept to auto-posting. We create content that drives
            real engagement, followers, and business results.
          </p>
            ...
            {[
              {
                ...
                price: '$999',
                period: '/month',
                features: ['3 reels per month', 'Basic editing', 'Trending music', 'Standard hashtags', 'Monthly analytics'],
                highlighted: false,
              },
              {
                name: 'Growth',
                price: '$1,999',
                period: '/month',
                features: ['8 reels per month', 'Professional editing', 'Trending audio optimization', 'Hashtag strategy', 'Weekly analytics', 'Community engagement'],
                highlighted: true,
              },
              {
                name: 'Viral',
                price: '$2,999',
                period: '/month',
                features: ['15 reels per month', 'Custom scripts', 'Premium editing & effects', 'Advanced hashtag strategy', 'Daily analytics', 'Full growth management', 'Priority support'],
                highlighted: false,
              },
            ].map((plan, i) => (
              <div key={i} className={`rounded-2xl p-8 relative overflow-hidden ${
                ...
                <div className="mb-6">
                  <span className={`text-5xl font-bold ${plan.highlighted ? 'text-white' : 'gradient-text'}`}>
                    {plan.price}
                  </span>
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature, j) => (
                    <li key={j} className="flex items-center gap-3">
                      ...
                      <span className={plan.highlighted ? 'text-blue-50' : 'text-[#94A3B8]'}>{feature}</span>
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="font-display text-6xl md:text-7xl text-white mb-6 uppercase">
            Ready to Create<br /><span className="gradient-text">Viral Content?</span>
          </h2>
          <p className="text-[#94A3B8] text-xl mb-10">
            Let's turn your brand story into engaging, viral-worthy Instagram reels.
          </p>
      ...
      <footer className="py-10 px-4 border-t border-[rgba(74,108,247,0.15)]" style={{ background: '#050B18' }}>
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="mt-4 flex justify-center gap-6 text-sm">
            <Link href="/" className="text-[#94A3B8] hover:text-[#4A6CF7] transition-colors">Home</Link>
            <Link href="/contact" className="text-[#94A3B8] hover:text-[#4A6CF7] transition-colors">Contact</Link>
            <Link href="#" className="text-[#94A3B8] hover:text-[#4A6CF7] transition-colors">Privacy</Link>
          </div>
        </div>
      </footer>
    </div>
