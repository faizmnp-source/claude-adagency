...
export const VOICES = {
  ...
  // Indian Voices (Multilingual v2 supports these)
  priya:   { id: '8v8v8v8v8v8v8v8v8v8v', name: 'Priya',   desc: 'Natural Indian female (Hindi/English)' },
  ananya:  { id: '9v9v9v9v9v9v9v9v9v9v', name: 'Ananya',  desc: 'Professional Indian female (Hindi/English)' },
  kabir:   { id: '10v10v10v10v10v10v10', name: 'Kabir',   desc: 'Deep Indian male (Hindi/English)' },
  aarav:   { id: '11v11v11v11v11v11v11', name: 'Aarav',   desc: 'Young Indian male (Hindi/English)' },
};
